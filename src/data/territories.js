  ...
  srivijaya: {
    ...
    timeline: {
      ...
      900: {
        ...
        keyEvents: [
          { year: 929, event: 'Sriwijaya-Mataram War ends — Mpu Sindok, aided by the people of Nganjuk, defeats Sriwijaya forces at Anjuk Ladang and founds the Medang Kingdom and the Isyana Dynasty, centered in East Java', type: 'political', eventId: 'Perang Sriwijaya-Mataram berakhir — Mpu Sindok, dibantu rakyat Nganjuk, mengalahkan pasukan Sriwijaya di Desa Anjuk Ladang dan mendirikan Kerajaan Medang serta Dinasti Isyana yang berpusat di Jawa Timur',
            citation: { citation: 'UNVERIFIED — based on traditional Javanese historiography; Battle of Anjuk Ladang not individually confirmed against Coedès', url: '' } },
          ...srivijayaMaritimeDominanceBase.keyEvents,
        ],
      },
      960: {
        ...srivijayaMaritimeDominanceBase,
...
tarumanagara: {
  ...
  timeline: {
    ...
    434: {
      era: 'Post-Purnawarman Period', eraId: 'Periode Pasca-Purnawarman',
      ruler: {
        portrait: '👑',
        title: 'Raja',
        name: 'Wisnuwarman',
        reignStart: 434,
        reignEnd: 455,
        citation: { citation: 'UNVERIFIED against Coedès — not mentioned by Coedès; rests on Sundanese historiography and local tradition', url: '' },
      },
      capital: 'Tarumanagara (near Bekasi/Bogor, West Java)',
      capitalId: 'Tarumanagara (sekitar Bekasi/Bogor, Jawa Barat)',
      population: '~100,000 (est.)',
      ...
      government: 'Hindu Kingdom',
      statCitations: {
        capital:    { citation: 'UNVERIFIED — continuity assumed from Purnawarman period', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found for this figure; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity assumed from Purnawarman period', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed from Purnawarman period', url: '' },
      },
      summary: 'Tarumanagara continues under Wisnuwarman, maintaining the Hindu traditions established by Purnawarman',
      summaryId: 'Tarumanagara berlanjut di bawah Wisnuwarman, mempertahankan tradisi Hindu yang didirikan oleh Purnawarman',
      keyEvents: [],
      historicalContext: 'Wisnuwarman succeeds Purnawarman and continues the Hindu kingdom of Tarumanagara in West Java.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Wisnuwarman menggantikan Purnawarman dan meneruskan kerajaan Hindu Tarumanagara di Jawa Barat.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade', 'Tribute'],
        primaryId: ['Pertanian', 'Perdagangan Sungai', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Timber', 'Ivory'],
        exportsId: ['Beras', 'Kayu', 'Gading'],
        exportsCitations: [], tradingPartners: ['India'],
        tradingPartnersId: ['India'],
        partnersCitations: [], economyCitationRefs: [],
      },
      culture: {
        language: 'Sanskrit', languageId: 'Sansekerta', languageCitations: [],
        script: 'Pallava Script', scriptId: 'Aksara Pallawa', scriptCitations: [],
        architecture: 'Hindu Temples', architectureId: 'Kuil-kuil Hindu', architectureCitations: [],
        literatureItems: [], literatureItemsId: [], literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['West Java', 'Citarum River Basin'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
      relations: { 'India': 'Cultural & Religious Exchange' },
      relationsId: { 'India': 'Pertukaran Budaya & Agama' },
      relationsCitations: [], relationsCitationRefs: [],
    },
    455: {
      era: 'Post-Purnawarman Period', eraId: 'Periode Pasca-Purnawarman',
      ruler: {
      ...
      government: 'Hindu Kingdom',
      statCitations: {
        capital:    { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found for this figure; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity assumed', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed', url: '' },
      },
      summary: 'Tarumanagara continues under Indrawarman across the 5th–6th centuries',
      summaryId: 'Tarumanagara berlanjut di bawah Indrawarman sepanjang abad ke-5 hingga ke-6',
      keyEvents: [],
      historicalContext: 'Indrawarman rules Tarumanagara during the long middle period of the kingdom.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Indrawarman memerintah Tarumanagara selama periode tengah yang panjang dari kerajaan ini.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade', 'Tribute'],
        primaryId: ['Pertanian', 'Perdagangan Sungai', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Timber'],
  ...
  relations: {},
    ...
    535: {
      ...
      populationId: '~90.000 (perkiraan)',
      religion: 'Hindu',
      government: 'Hindu Kingdom',
      statCitations: {
        capital:    { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity assumed', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed', url: '' },
      },
      summary: 'Tarumanagara continues under Suryawarman, son of Candrawarman',
      summaryId: 'Tarumanagara berlanjut di bawah Suryawarman, putra Candrawarman',
      keyEvents: [],
      historicalContext: 'Suryawarman, son of Candrawarman, continues the rule of Tarumanagara.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Suryawarman, putra Candrawarman, meneruskan pemerintahan Tarumanagara.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India'], tradingPartnersId: ['India'],
        partnersCitations: [], economyCitationRefs: [],
      },
      culture: {
        language: 'Sanskrit, Old Sundanese', languageId: 'Sansekerta, Sunda Kuno', languageCitations: [],
        script: 'Pallava Script', scriptId: 'Aksara Pallawa', scriptCitations: [],
        architecture: 'Stone Inscriptions', architectureId: 'Prasasti batu', architectureCitations: [],
        literatureItems: [], literatureItemsId: [], literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['West Java'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
      relations: {}, relationsId: {}, relationsCitations: [], relationsCitationRefs: [],
    },
    561: {
      era: 'Late Period', eraId: 'Periode Akhir',
      ruler: {
        ...
        reignStart: 561,
        reignEnd: 628,
        citation: { citation: 'Tarumanagara — Grokipedia (Kertawarman\'s reign 561–628 CE, included diplomatic outreach to China; envoys recorded at the Sui court in 607 CE)', url: 'https://grokipedia.com/page/Tarumanagara' },
      },
      capital: 'Tarumanagara (near Bekasi/Bogor, West Java)',
      capitalId: 'Tarumanagara (sekitar Bekasi/Bogor, Jawa Barat)',
      population: '~90,000 (est.)',
      ...
      summary: 'Tarumanagara under Kertawarman establishes diplomatic contact with China, recorded in the Sui Shu',
      summaryId: 'Tarumanagara di bawah Kertawarman menjalin kontak diplomatik dengan Tiongkok, tercatat dalam Sui Shu',
      keyEvents: [
        { year: 607, event: 'Kertawarman sends envoys to the Sui Chinese court, recorded as "Po-li" or "Taruma"', type: 'political',
          eventId: 'Kertawarman mengirim utusan ke istana Dinasti Sui Tiongkok, tercatat sebagai "Po-li" atau "Taruma"',
          citation: { citation: 'Tarumanagara — Grokipedia (Kertawarman\'s 607 CE embassy to the Sui court)', url: 'https://grokipedia.com/page/Tarumanagara' } },
      ],
      historicalContext: 'Kertawarman\'s long reign includes the kingdom\'s only confirmed diplomatic contact with China — envoys arriving at the Sui court in 607 CE, recorded under the names "Po-li" or "Taruma".\n\nHis reign is not covered by Coedès directly; this evidence comes from Chinese dynastic records.',
      historicalContextId: 'Masa pemerintahan Kertawarman yang panjang mencakup satu-satunya kontak diplomatik kerajaan yang terkonfirmasi dengan Tiongkok — utusan tiba di istana Sui pada 607 M, tercatat dengan nama "Po-li" atau "Taruma".\n\nMasa pemerintahannya tidak dibahas langsung oleh Coedès; bukti ini berasal dari catatan dinasti Tiongkok.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India', 'China'], tradingPartnersId: ['India', 'Tiongkok'],
        partnersCitations: [], economyCitationRefs: [],
      },
      culture: {
        language: 'Sanskrit, Old Sundanese', languageId: 'Sansekerta, Sunda Kuno', languageCitations: [],
      ...
      territories: ['West Java'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
      relations: { 'China': 'Diplomatic Contact' }, relationsId: { 'Tiongkok': 'Kontak Diplomatik' },
      relationsCitations: [], relationsCitationRefs: [],
    },
    628: {
      era: 'Late Period', eraId: 'Periode Akhir',
      ...
      summary: 'Tarumanagara enters its final phase under Sudhawarman as the kingdom begins to fragment',
      summaryId: 'Tarumanagara memasuki fase terakhirnya di bawah Sudhawarman saat kerajaan mulai terfragmentasi',
      keyEvents: [],
      historicalContext: 'Sudhawarman rules during the weakening of Tarumanagara in the 7th century.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Sudhawarman memerintah selama melemahnya Tarumanagara pada abad ke-7.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India'], tradingPartnersId: ['India'],
    ...
    639: {
      ...
      summary: 'Hariwangsawarman holds the throne for only one year before his successor takes power',
      summaryId: 'Hariwangsawarman memegang takhta hanya satu tahun sebelum penerusnya mengambil alih kekuasaan',
      keyEvents: [],
      historicalContext: 'Hariwangsawarman\'s extremely brief reign of one year reflects the political instability of Tarumanagara in its final decades.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Masa pemerintahan Hariwangsawarman yang sangat singkat selama satu tahun mencerminkan ketidakstabilan politik Tarumanagara pada dekade-dekade terakhirnya.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India'], tradingPartnersId: ['India'],
    ...
    640: {
      ...
      summary: 'Tarumanagara continues to weaken under Nagajayawarman in its penultimate reign',
      summaryId: 'Tarumanagara terus melemah di bawah Nagajayawarman dalam pemerintahan terakhir keduanya',
      keyEvents: [],
      historicalContext: 'Nagajayawarman rules during the kingdom\'s final decades before its dissolution into Sunda and Galuh.\n\nHis reign is not documented by Coedès; evidence rests on later Sundanese traditions.',
      historicalContextId: 'Nagajayawarman memerintah selama dekade-dekade terakhir kerajaan sebelum pembubarannya menjadi Sunda dan Galuh.\n\nMasa pemerintahannya tidak didokumentasikan oleh Coedès; bukti bergantung pada tradisi Sunda yang lebih belakangan.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India'], tradingPartnersId: ['India'],
    ...
    666: {
      era: 'Final Period', eraId: 'Periode Terakhir',
      ruler: {
        portrait: '👑',
        title: 'Raja',
        name: 'Linggawarman',
        reignStart: 666,
        reignEnd: 669,
        citation: { citation: 'Kingdom of Sunda and Galuh — New World Encyclopedia (last king Linggawarman devolved the kingdom to his son-in-law Tarusbawa in 669, after which the kingdom formally split into Sunda and Galuh)', url: 'https://www.newworldencyclopedia.org/entry/Kingdom_of_Sunda_and_Galuh' },
      },
      capital: 'Tarumanagara (near Bekasi/Bogor, West Java)',
      capitalId: 'Tarumanagara (sekitar Bekasi/Bogor, Jawa Barat)',
      population: '~80,000 (est.)',
      ...
      summary: 'Linggawarman is the last ruler of Tarumanagara, who devolves the kingdom to his son-in-law Tarusbawa in 669, leading to the formation of Sunda and Galuh',
      summaryId: 'Linggawarman adalah penguasa terakhir Tarumanagara, yang menyerahkan kerajaan kepada menantunya Tarusbawa pada 669, yang mengakibatkan terbentuknya Sunda dan Galuh',
      keyEvents: [
        { year: 669, event: 'Linggawarman devolves Tarumanagara to son-in-law Tarusbawa — kingdom dissolves into Sunda and Galuh', type: 'political',
          eventId: 'Linggawarman menyerahkan Tarumanagara kepada menantunya Tarusbawa — kerajaan terpecah menjadi Sunda dan Galuh',
          citation: { citation: 'Kingdom of Sunda and Galuh — New World Encyclopedia (last king Linggawarman devolved the kingdom to Tarusbawa in 669)', url: 'https://www.newworldencyclopedia.org/entry/Kingdom_of_Sunda_and_Galuh' } },
      ],
      historicalContext: 'Linggawarman is the last king of Tarumanagara. He passes the kingdom to his son-in-law Tarusbawa in 669 CE, after which the kingdom formally divides into Sunda and Galuh.\n\nThis dissolution is documented in Sundanese and New World Encyclopedia sources; Coedès\' narrative by this point had shifted to focus on Srivijaya and the emerging Sailendra Java.',
      historicalContextId: 'Linggawarman adalah raja terakhir Tarumanagara. Ia menyerahkan kerajaan kepada menantunya Tarusbawa pada 669 M, setelah itu kerajaan secara resmi terbagi menjadi Sunda dan Galuh.\n\nPembubaran ini didokumentasikan dalam sumber-sumber Sunda dan New World Encyclopedia; narasi Coedès pada titik ini telah beralih fokus ke Sriwijaya dan Sailendra Jawa yang sedang berkembang.',
      economy: {
        primary: ['Agriculture', 'River Trade'], primaryId: ['Pertanian', 'Perdagangan Sungai'],
        primaryCitations: [], exports: ['Rice', 'Timber'], exportsId: ['Beras', 'Kayu'],
        exportsCitations: [], tradingPartners: ['India'], tradingPartnersId: ['India'],
...
mataram: {
  ...
  timeline: {
    ...
    746: {
      era: 'Sanjaya Dynasty', eraId: 'Dinasti Sanjaya',
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Panangkaran',
        reignStart: 746, reignEnd: 784,
        citation: { citation: 'UNVERIFIED against Coedès — not named individually by Coedès; known from local Javanese inscriptions and Sanjaya dynastic lists', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~300,000 (est.)', populationId: '~300.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed from Sanjaya period', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
        religion: { citation: 'UNVERIFIED — continuity of Shaivite tradition assumed', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed', url: '' },
      },
      summary: 'Rakai Panangkaran continues the Sanjaya dynasty, overseeing the early coexistence with the Buddhist Sailendra influence',
      summaryId: 'Rakai Panangkaran melanjutkan dinasti Sanjaya, mengawasi koeksistensi awal dengan pengaruh Buddha Sailendra',
      keyEvents: [],
      historicalContext: 'Rakai Panangkaran succeeds Sanjaya and rules during a period when Buddhist Sailendra influence begins to grow alongside the Shaivite Sanjaya tradition.\n\nHis reign is not individually documented by Coedès, who covers this period under the broader Sailendra narrative.',
      historicalContextId: 'Rakai Panangkaran menggantikan Sanjaya dan memerintah pada periode ketika pengaruh Buddha Sailendra mulai tumbuh berdampingan dengan tradisi Saiwa Sanjaya.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès, yang membahas periode ini di bawah narasi Sailendra yang lebih luas.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
        exportsId: ['Beras', 'Rempah-rempah', 'Tekstil'],
        exportsCitations: [], tradingPartners: ['India', 'Srivijaya'],
        tradingPartnersId: ['India', 'Sriwijaya'],
        partnersCitations: [], economyCitationRefs: [],
      },
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Hindu Temples (Shaivite)', architectureId: 'Kuil-kuil Hindu (Saiwa)', architectureCitations: [],
        literatureItems: ['Sanskrit Inscriptions'], literatureItemsId: ['Prasasti Sansekerta'],
        literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['Central Java', 'Kedu Plain'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
      relations: {}, relationsId: {}, relationsCitations: [], relationsCitationRefs: [],
    },
    784: {
      ...
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Panunggalan',
        reignStart: 784, reignEnd: 803,
        citation: { citation: 'UNVERIFIED against Coedès — not named individually by Coedès; known from local Javanese inscriptions and Sanjaya dynastic lists', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~320,000 (est.)', populationId: '~320.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
      ...
      summary: 'Rakai Panunggalan rules Mataram during the growing Sailendra Buddhist influence in Central Java',
      summaryId: 'Rakai Panunggalan memerintah Mataram di tengah pengaruh Buddha Sailendra yang semakin kuat di Jawa Tengah',
      keyEvents: [],
      historicalContext: 'Rakai Panunggalan rules during the period when Sailendra Buddhist power is at its height in Central Java, with Borobudur under construction.\n\nHis reign is not individually documented by Coedès.',
      historicalContextId: 'Rakai Panunggalan memerintah pada periode ketika kekuatan Buddha Sailendra berada di puncaknya di Jawa Tengah, dengan Borobudur sedang dalam pembangunan.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
      ...
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Borobudur (under construction)', architectureId: 'Borobudur (dalam pembangunan)', architectureCitations: [],
        literatureItems: ['Sanskrit Inscriptions'], literatureItemsId: ['Prasasti Sansekerta'],
        literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['Central Java', 'Kedu Plain'], territoriesCitations: [],
    ...
    803: {
      ...
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Warak',
        reignStart: 803, reignEnd: 827,
        citation: { citation: 'UNVERIFIED against Coedès — not named individually by Coedès; known from local Javanese inscriptions and Sanjaya dynastic lists', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~380,000 (est.)', populationId: '~380.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
      ...
      summary: 'Rakai Warak rules Mataram alongside the Sailendra Buddhist dynasty as both powers coexist in Central Java',
      summaryId: 'Rakai Warak memerintah Mataram berdampingan dengan dinasti Buddha Sailendra saat kedua kekuatan koeksistensi di Jawa Tengah',
      keyEvents: [],
      historicalContext: 'Rakai Warak rules the Sanjaya lineage of Mataram while the Sailendra dynasty simultaneously holds influence in the same region.\n\nHis reign is not individually documented by Coedès.',
      historicalContextId: 'Rakai Warak memerintah garis Sanjaya Mataram sementara dinasti Sailendra secara bersamaan mempertahankan pengaruh di wilayah yang sama.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
      ...
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Borobudur, Prambanan (early)', architectureId: 'Borobudur, Prambanan (awal)', architectureCitations: [],
        literatureItems: ['Sanskrit Inscriptions', 'Kawi Poetry'],
        literatureItemsId: ['Prasasti Sansekerta', 'Puisi Kawi'],
        literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['Central Java', 'Kedu Plain'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
    ...
    827: {
      ...
      ruler: {
        portrait: '👑', title: 'Raja',
        name: 'Dyah Gula',
        reignStart: 827, reignEnd: 829,
        citation: { citation: 'UNVERIFIED against Coedès — not named individually by Coedès; known from local Javanese inscriptions', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~380,000 (est.)', populationId: '~380.000 (perkiraan)',
      ...
      summary: 'Dyah Gula holds the throne briefly for two years before Rakai Garung succeeds',
      summaryId: 'Dyah Gula memegang takhta hanya dua tahun sebelum digantikan Rakai Garung',
      keyEvents: [],
      historicalContext: 'Dyah Gula\'s brief two-year reign reflects a transitional moment in the Sanjaya dynasty.\n\nHis reign is not individually documented by Coedès.',
      historicalContextId: 'Masa pemerintahan singkat Dyah Gula selama dua tahun mencerminkan momen transisi dalam dinasti Sanjaya.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices'],
        exportsId: ['Beras', 'Rempah-rempah'],
        exportsCitations: [], tradingPartners: ['India', 'Srivijaya'],
        tradingPartnersId: ['India', 'Sriwijaya'],
        partnersCitations: [], economyCitationRefs: [],
      ...
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Hindu-Buddhist Temples', architectureId: 'Kuil-kuil Hindu-Buddha', architectureCitations: [],
        literatureItems: [], literatureItemsId: [], literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['Central Java', 'Kedu Plain'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
    ...
    829: {
      ...
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Garung',
        reignStart: 829, reignEnd: 847,
        citation: { citation: 'UNVERIFIED against Coedès — not named individually by Coedès; known from local Javanese inscriptions and Sanjaya dynastic lists', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~400,000 (est.)', populationId: '~400.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
      ...
      summary: 'Rakai Garung rules Mataram as the Sanjaya line asserts itself alongside the declining Sailendra power',
      summaryId: 'Rakai Garung memerintah Mataram saat garis Sanjaya menegaskan dirinya berdampingan dengan kekuatan Sailendra yang melemah',
      keyEvents: [],
      historicalContext: 'Rakai Garung\'s reign marks a period of gradual Sanjaya reassertion as Sailendra power shifts increasingly to Srivijaya in Sumatra.\n\nHis reign is not individually documented by Coedès.',
      historicalContextId: 'Masa pemerintahan Rakai Garung menandai periode penegasan kembali Sanjaya secara bertahap saat kekuatan Sailendra semakin beralih ke Sriwijaya di Sumatra.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
      ...
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Prambanan (early construction)', architectureId: 'Prambanan (konstruksi awal)', architectureCitations: [],
        literatureItems: ['Kawi Poetry'], literatureItemsId: ['Puisi Kawi'],
        literatureCitations: [], cultureCitationRefs: [],
      },
      territories: ['Central Java', 'Kedu Plain'], territoriesCitations: [],
      vassals: [], vassalsCitations: [], rivals: [], rivalsCitations: [],
    ...
    847: {
      era: 'Sanjaya Restoration', eraId: 'Restorasi Sanjaya',
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Pikatan',
        reignStart: 847, reignEnd: 855,
        citation: { citation: 'Coedès, G. The Indianized States of Southeast Asia (1968/1975), Chapter VIII §3 "The Javanese Kingdom of Mataram", p.110 — Coedès documents the Sanjaya restoration under Rakai Pikatan, who defeated the last Sailendra ruler in Java', url: 'https://cdn.angkordatabase.asia/libs/docs/The-Indianized-States-of-Southeast-Asia-by-George-Coedes-z-lib.org.pdf' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~420,000 (est.)', populationId: '~420.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed; Coedès Ch.VIII §3 covers this period without specifying the capital name', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
        religion: { citation: 'Coedès, Chapter VIII §3, p.110 — Sanjaya Shaivite restoration after Sailendra Buddhist dominance', url: 'https://cdn.angkordatabase.asia/libs/docs/The-Indianized-States-of-Southeast-Asia-by-George-Coedes-z-lib.org.pdf' },
      ...
      summary: 'Rakai Pikatan defeats the last Sailendra ruler in Java, restoring full Sanjaya-Hindu dominance over Mataram',
      summaryId: 'Rakai Pikatan mengalahkan penguasa Sailendra terakhir di Jawa, memulihkan dominasi penuh Hindu Sanjaya atas Mataram',
      keyEvents: [
        { year: 850, event: 'Rakai Pikatan defeats last Sailendra ruler in Java — Sanjaya dynasty fully restored', type: 'political',
          eventId: 'Rakai Pikatan mengalahkan penguasa Sailendra terakhir di Jawa — dinasti Sanjaya sepenuhnya dipulihkan',
          citation: { citation: 'Coedès, Chapter VIII §3 "The Javanese Kingdom of Mataram", p.110 — Sanjaya restoration documented', url: 'https://cdn.angkordatabase.asia/libs/docs/The-Indianized-States-of-Southeast-Asia-by-George-Coedes-z-lib.org.pdf' } },
      ],
      historicalContext: 'Rakai Pikatan\'s reign marks the decisive restoration of Sanjaya-Hindu rule in Mataram, as documented by Coedès under "The Javanese Kingdom of Mataram."\n\nHis victory over the last Sailendra ruler in Java ends Buddhist Sailendra dominance on the island; the remaining Sailendras retreat to Srivijaya in Sumatra.',
      historicalContextId: 'Masa pemerintahan Rakai Pikatan menandai pemulihan tegas aturan Hindu Sanjaya di Mataram, sebagaimana didokumentasikan Coedès di bawah "The Javanese Kingdom of Mataram."\n\nKemenangannya atas penguasa Sailendra terakhir di Jawa mengakhiri dominasi Buddha Sailendra di pulau itu; Sailendra yang tersisa mundur ke Sriwijaya di Sumatra.',
      historicalContextCitationRefs: [
      ...
      economy: {
        ...
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
        exportsId: ['Beras', 'Rempah-rempah', 'Tekstil'],
        exportsCitations: [], tradingPartners: ['India', 'China'],
        tradingPartnersId: ['India', 'Tiongkok'],
        partnersCitations: [], economyCitationRefs: [],
      },
      culture: {
        language: 'Old Javanese, Sanskrit', languageId: 'Jawa Kuno, Sansekerta', languageCitations: [],
        script: 'Kawi Script', scriptId: 'Aksara Kawi', scriptCitations: [],
        architecture: 'Prambanan Temple Complex', architectureId: 'Kompleks Candi Prambanan', architectureCitations: [],
        literatureItems: ['Sanskrit Inscriptions', 'Kawi Poetry'],
        literatureItemsId: ['Prasasti Sansekerta', 'Puisi Kawi'],
        literatureCitations: [], cultureCitationRefs: [],
      },
    ...
    855: {
      ...
      ruler: {
        portrait: '👑', title: 'Rakai',
        name: 'Rakai Kayuwangi',
        reignStart: 855, reignEnd: 885,
        citation: { citation: 'UNVERIFIED against Coedès directly — not named individually by Coedès; falls within Coedès\' Ch.VIII §3 "The Javanese Kingdom of Mataram" window but not named there in the fetched material', url: '' },
      },
      capital: 'Medang ri Poh Pitu (Kedu Plain, Central Java)',
      capitalId: 'Medang ri Poh Pitu (Dataran Kedu, Jawa Tengah)',
      population: '~430,000 (est.)', populationId: '~430.000 (perkiraan)',
      religion: 'Hindu (Shaivism)', government: 'Hindu Kingdom',
      statCitations: {
        capital: { citation: 'UNVERIFIED — continuity assumed', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found; treat as estimate', url: '' },
        religion: { citation: 'UNVERIFIED — continuity of Sanjaya Shaivite tradition assumed', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed', url: '' },
      },
      summary: 'Rakai Kayuwangi consolidates the Sanjaya restoration following Rakai Pikatan\'s victory over the Sailendras',
      summaryId: 'Rakai Kayuwangi mengkonsolidasikan restorasi Sanjaya setelah kemenangan Rakai Pikatan atas Sailendra',
      transitionNote: 'After the Srivijaya-Mataram war came to an end, Mpu Sindok founded the Medang Kingdom in 929 CE — showing last recorded state',
      transitionNoteId: 'Setelah perang Sriwijaya-Mataram berakhir, Mpu Sindok mendirikan Kerajaan Medang pada 929 M — menampilkan catatan terakhir',
      keyEvents: [
        { year: 929, event: 'Sriwijaya-Mataram War ends — Mpu Sindok, aided by the people of Nganjuk, defeats Sriwijaya forces at Anjuk Ladang and founds the Medang Kingdom and the Isyana Dynasty, centered in East Java', type: 'political', eventId: 'Perang Sriwijaya-Mataram berakhir — Mpu Sindok, dibantu rakyat Nganjuk, mengalahkan pasukan Sriwijaya di Desa Anjuk Ladang dan mendirikan Kerajaan Medang serta Dinasti Isyana yang berpusat di Jawa Timur',
          citation: { citation: 'UNVERIFIED — based on traditional Javanese historiography; Battle of Anjuk Ladang and Nganjuk involvement not individually confirmed against Coedès', url: '' } },
      ],
      historicalContext: 'Rakai Kayuwangi rules during the consolidation of Sanjaya power following the expulsion of the Sailendras from Java.\n\nHis reign is not individually documented by Coedès, who covers this period under the broader Mataram narrative in Ch.VIII §3.',
      historicalContextId: 'Rakai Kayuwangi memerintah selama konsolidasi kekuatan Sanjaya setelah pengusiran Sailendra dari Jawa.\n\nMasa pemerintahannya tidak didokumentasikan secara individual oleh Coedès, yang membahas periode ini di bawah narasi Mataram yang lebih luas di Bab VIII §3.',
      economy: {
        primary: ['Agriculture', 'Wet Rice Cultivation', 'Tribute'],
        primaryId: ['Pertanian', 'Budidaya Padi Sawah', 'Upeti'],
        primaryCitations: [], exports: ['Rice', 'Spices', 'Textiles'],
    ...
    929: {
      ...
      keyEvents: [
        { year: 929, event: 'Mpu Sindok moves the capital from Central Java to East Java', type: 'political', eventId: 'Mpu Sindok memindahkan ibu kota dari Jawa Tengah ke Jawa Timur',
          citation: { citation: 'Coedès, Chapter VIII §3 "The Javanese Kingdom of Mataram", p.110', url: 'https://cdn.angkordatabase.asia/libs/docs/The-Indianized-States-of-Southeast-Asia-by-George-Coedes-z-lib.org.pdf' } },
      ],
...
panjalu: {
  ...
  timeline: {
    1042: {
      era: 'Early Kingdom', eraId: 'Kerajaan Awal',
      renamedTo: 'Kediri', renamedToId: 'Kediri',
      ruler: {
        portrait: '👑',
        title: 'Raja',
  ...
  timeline: {
    ...
    1052: {
      ...
      ruler: {
        ...
        reignStart: 1052,
        reignEnd: 1059,
        citation: { citation: 'UNVERIFIED against Coedès — Coedès does not name Janggala rulers individually; this entry rests on local Javanese historiography', url: '' },
      },
      capital: 'Kahuripan (Sidoarjo, East Java)',
      capitalId: 'Kahuripan (Sidoarjo, Jawa Timur)',
      population: '~250,000 (est.)',
      ...
      government: 'Hindu-Buddhist Kingdom',
      statCitations: {
        capital:    { citation: 'UNVERIFIED — continuity assumed from 1042 period', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found for this figure; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity assumed from 1042 period', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed from 1042 period', url: '' },
      },
      summary: 'Janggala continues under Alanjung Ahyes, maintaining its rivalry with Panjalu',
      summaryId: 'Janggala berlanjut di bawah Alanjung Ahyes, mempertahankan persaingannya dengan Panjalu',
      keyEvents: [],
      historicalContext: "Alanjung Ahyes rules Janggala during the continuing rivalry with Panjalu.\n\nAs with the broader Janggala/Panjalu framing, Coedès does not name this ruler — he treats the entire post-Airlangga East Javanese polity as 'Kadiri' without separating the two sister kingdoms.",
      historicalContextId: 'Alanjung Ahyes memerintah Janggala di tengah persaingan yang terus berlanjut dengan Panjalu.\n\nSeperti konteks Janggala/Panjalu secara keseluruhan, Coedès tidak menyebut penguasa ini — ia memperlakukan seluruh kerajaan Jawa Timur pasca-Airlangga sebagai "Kadiri" tanpa memisahkan dua kerajaan saudara itu.',
      economy: {
        primary: ['Agriculture', 'Coastal Trade', 'Tribute'],
        primaryId: ['Pertanian', 'Perdagangan Pesisir', 'Upeti'],
        primaryCitations: [],
    ...
    1059: {
      ...
      government: 'Hindu-Buddhist Kingdom',
      statCitations: {
        capital:    { citation: 'UNVERIFIED — continuity assumed from 1052 period', url: '' },
        population: { citation: 'UNVERIFIED — no academic source found for this figure; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity assumed from 1052 period', url: '' },
        government: { citation: 'UNVERIFIED — continuity assumed from 1052 period', url: '' },
      },
      summary: 'Janggala continues under Samarotsaha, maintaining its rivalry with Panjalu',
      summaryId: 'Janggala berlanjut di bawah Samarotsaha, mempertahankan persaingannya dengan Panjalu',
      keyEvents: [],
      historicalContext: "Samarotsaha rules Janggala following Alanjung Ahyes, with the end of his reign undocumented in surviving sources.\n\nAs with the broader Janggala framing, Coedès does not name this ruler — he treats the entire post-Airlangga East Javanese polity as 'Kadiri' without separating the two sister kingdoms.",
      historicalContextId: 'Samarotsaha memerintah Janggala setelah Alanjung Ahyes, dengan akhir masa pemerintahannya tidak terdokumentasi dalam sumber yang masih ada.\n\nSeperti konteks Janggala secara keseluruhan, Coedès tidak menyebut penguasa ini — ia memperlakukan seluruh kerajaan Jawa Timur pasca-Airlangga sebagai "Kadiri" tanpa memisahkan dua kerajaan saudara itu.',
      economy: {
        primary: ['Agriculture', 'Coastal Trade', 'Tribute'],
        primaryId: ['Pertanian', 'Perdagangan Pesisir', 'Upeti'],
        primaryCitations: [],
  ...
  timeline: {
    ...
    1182: {
      ...
      ruler: {
        ...
        reignStart: 1182,
        reignEnd: 1194,
        citation: { citation: 'UNVERIFIED against Coedès — Coedès does not name Kameshwara individually; his Ch.X §8 covers Kadiri 1115–1178 and Ch.XI §8 opens at 1222; this reign falls in the gap between those sections', url: '' },
      },
      capital: 'Daha (Kediri)',
      population: '~300,000 (est.)',
      populationId: '~300.000 (perkiraan)',
      ...
      government: 'Hindu Kingdom',
      statCitations: {
        capital:    { citation: 'Coedès, Chapter X §8, p.152-168 — Daha as the seat of the Kadiri kingdom; continuity assumed', url: 'https://cdn.angkordatabase.asia/libs/docs/The-Indianized-States-of-Southeast-Asia-by-George-Coedes-z-lib.org.pdf' },
        population: { citation: 'UNVERIFIED — no academic source found for this figure; treat as estimate', url: '' },
        religion:   { citation: 'UNVERIFIED — continuity from Jayabaya period assumed', url: '' },
        government: { citation: 'UNVERIFIED — continuity from Jayabaya period assumed', url: '' },
      },
      summary: 'Kediri under Kameshwara continues as the dominant East Javanese power, known for literary patronage',
      summaryId: 'Kediri di bawah Kameshwara terus menjadi kekuatan dominan Jawa Timur, dikenal karena perlindungan sastra',
      keyEvents: [],
      historicalContext: "Kameshwara rules Kediri during a continuation of the kingdom's cultural flowering.\n\nHis reign is associated with the composition of the Kakawin Smaradahana by Mpu Dharmaja, one of the great works of Old Javanese literature.",
      historicalContextId: 'Kameshwara memerintah Kediri selama kelangsungan perkembangan budaya kerajaan.\n\nMasa pemerintahannya dikaitkan dengan penggubahan Kakawin Smaradahana oleh Mpu Dharmaja, salah satu karya agung sastra Jawa Kuno.',
      economy: {
        primary: ['Agriculture', 'River Trade', 'Tribute'],
        primaryId: ['Pertanian', 'Perdagangan Sungai', 'Upeti'],
        primaryCitations: [],
        ...
        exportsId: ['Beras', 'Kapas', 'Hasil Pertanian'],
        exportsCitations: [],
        tradingPartners: ['China', 'India'],
        tradingPartnersId: ['Tiongkok', 'India'],
        partnersCitations: [],
        economyCitationRefs: [],
      },
      culture: {
        ...
        scriptId: 'Kawi, Jawa Kuno',
        scriptCitations: [],
        architecture: 'Candi Penataran',
        architectureId: 'Candi Penataran',
        architectureCitations: [],
        literatureItems: ['Kakawin Smaradahana'],
        literatureItemsId: ['Kakawin Smaradahana'],
        literatureCitations: [],
        cultureCitationRefs: [],
      },
      territories: ['East Java', 'Daha River Basin'],
