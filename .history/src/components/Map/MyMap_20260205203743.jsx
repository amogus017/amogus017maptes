    ...
    return (
        <div 
            ...
            style={{
                ...
                zIndex: 650,
                transformOrigin: '0 0',
                willChange: 'transform' // Optimize for smooth transform
            }}
        >
            {labels.map((label) => {
                // Convert lat/lng to layer point (not container point!)
        ...
        return (
          <div className="map-wrapper">
            ...
            >
              ...
              {/* Territory Labels - Perfectly smooth, no recalculation during zoom */}
