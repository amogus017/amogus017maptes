...
// Leaflet-based territory labels — direct DOM, no React state, no hooks
class TerritoryLabelsLayer extends Component {
    ...
    removeMapListeners = () => {
        const { map } = this.props;
        if (!map || !this.updatePositions) return;
    ...
    createLabels = () => {
        ...
        // Use the built-in markerPane — it participates in zoom animation
        // so labels move smoothly with the map instead of lagging
...
class MyMap extends Component {
    ...
    onEachTerritory = (empire) => (territory, layer) => {
        ...
        layer.on({
            click: () => {
                if (this.props.onTerritoryClick) this.props.onTerritoryClick(info);
            },
        ...
        return (
            <div className="map-wrapper">
                ...
                >
                    ...
                    {/* MapConsumer gives map instance without re-rendering on map events */}
