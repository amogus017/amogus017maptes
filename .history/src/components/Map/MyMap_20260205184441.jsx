                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      // FONT COLOR & STYLE - CHANGE THESE
                      color: "#D4AF37", // Metallic gold color
                      fontSize: `${label.fontSize}px`, // Dynamic size from labelUtils.js
                      fontWeight: "900", // Extra bold
                      fontFamily: "Georgia, serif", // Classic serif font
                      letterSpacing: "3px", // Wide spacing
                      textTransform: "uppercase", // ALL CAPS

                      // TEXT SHADOW - Brown outline + gold glow
                      textShadow: `-2px -2px 0 #8B4513, 2px -2px 0 #8B4513, -2px 2px 0 #8B4513, 2px 2px 0 #8B4513, 0 0 12px rgba(212, 175, 55, 0.8)`,
