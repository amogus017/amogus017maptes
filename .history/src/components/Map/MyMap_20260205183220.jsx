...
function TerritoryLabels({ empires, currentYear }) {
    ...
    React.useEffect(() => {
        ...
        // Only recalculate label positions when movement ends
        map.on('moveend', updateLabels);
        map.on('zoomend', updateLabels);
        
        // Update overlay transform during movement to keep labels stuck
        ...
        return (
          <div className="map-wrapper">
            ...
            >
              ...
              {/* Territory Labels - Now stick to map during panning */}
