...
class MyMap extends Component {
    ...
    loadEmpiresForYear = (year) => {
        ...
        const labels = empires.map(empire => {
            ...
            if (empire.boundary.type === 'FeatureCollection') {
                // Use first feature's geometry
                center = this.calculateCenter(empire.boundary.features[0].geometry);
            } else if (empire.boundary.geometry) {
                center = this.calculateCenter(empire.boundary.geometry);
            }
