  ...
  const panelVariants = {
    ...
    visible: { 
      ...
      transition: {
        ...
        duration: 0.3,
        ease: [0, 0, 0.2, 1],
        delay: 0.05 // Slight stagger after territory panel
      }
    }
  };
                ...
                <div key={section.id} className="wiki-section">
                  ...
                  {section.isIntro ? (
                    ...
                    <>
                      ...
                      {/* OPTIMIZED: Use max-height instead of height:auto for better performance */}
                      <AnimatePresence initial={false}>
                        {!collapsedSections[section.id] && (
                          <motion.div
                            ...
                            animate={{ 
                              opacity: 1, 
                              maxHeight: 2000, // Set a reasonable max-height instead of 'auto'
                              transition: {
