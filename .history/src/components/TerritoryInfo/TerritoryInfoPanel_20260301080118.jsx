...
const TerritoryInfoPanel = ({ territoryId, currentYear, isOpen, onClose }) => {
  ...
  const { territoryInfo, stats, ruler, culture, relations, history, economyInfo } = territoryData;
  ...
  return (
    <AnimatePresence mode="wait">
      {isOpen && (
        <>
          {/* Two backdrop variants: one when wiki is closed, one when open */}
          <AnimatePresence>
            {!wikiOpen && (
              <motion.div
          ...
          >
            ...
            <div className="v3-panel-header">
              ...
              <div className="header-content">
                <div className="era-badge" style={{ background: territoryInfo.colorPrimary }}>
                  {territoryInfo.era}
                </div>
                <h2 className="territory-name">{territoryInfo.name}</h2>
                  ...
                  >
                    ...
                    <div className="v3-stats-grid">
                      <div className="v3-stat-card">
                        ...
                        <div className="stat-value">{stats.treasury.toLocaleString()}</div>
                        <div className="stat-unit">Gold Ducats</div>
                      </div>
                      <div className="v3-stat-card">
                        <div className="stat-label">🏛️ Authority</div>
                        <div className="stat-value">{stats.authority}%</div>
                        <div className="stat-unit">Centralization</div>
                      </div>
                      <div className="v3-stat-card">
                        <div className="stat-label">⚔️ Military</div>
                        <div className="stat-value">{stats.military.toLocaleString()}</div>
                      ...
                      <div className="v3-stat-card">
                        ...
                        <div className="stat-value">{stats.stability}%</div>
                        <div className="stat-unit">Internal Peace</div>
                      </div>
                      <div className="v3-stat-card">
                        <div className="stat-label">📈 Prestige</div>
                        <div className="stat-value">{stats.prestige}</div>
                    ...
                    <div className="v3-ruler-card">
                      ...
                      <div className="ruler-info">
                        <div className="ruler-title">{ruler.title}</div>
                        <div className="ruler-name">{ruler.name}</div>
                        <div className="ruler-reign">Reign: {ruler.reign}</div>
                        {ruler.traits && (
                  ...
                  >
                    <div className="culture-grid">
                      <div className="culture-card">
                        ...
                        <div className="culture-value">{culture.language}</div>
                      </div>
                      ...
                      <div className="culture-card">
                        ...
                        <div className="culture-value">{culture.religion}</div>
                      </div>
                      ...
                      <div className="culture-card full-width">
                        ...
                        <div className="culture-value">{culture.architecture}</div>
                      </div>
                      ...
                      <div className="culture-card full-width">
                        ...
                        <div className="culture-value">{culture.practices}</div>
                      </div>
                    </div>
                  </motion.div>
                )}
          ...
          <WikiPanel
            ...
            territoryName={territoryInfo.nameEnglish || territoryInfo.name}
            isOpen={wikiOpen}
