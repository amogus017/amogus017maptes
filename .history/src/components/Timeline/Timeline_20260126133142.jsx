    ...
    <div className="victoria3-timeline">
      ...
      <div className="v3-slider-container">
        <div className="slider-frame">
            ...
            <input
              ...
              style={{
                background: `linear-gradient(to right, 
                  #8B4513 0%, 
                  #8B4513 ${((year - 1800) / 224) * 100}%, 
                  #F4E8D0 ${((year - 1800) / 224) * 100}%, 
                  #F4E8D0 100%)`
              }}
            />
          </div>
          ...
          {/* Era Indicators */}
          <div className="era-indicators">
            <div className="era-mark" style={{ left: '0%' }}>1800</div>
            <div className="era-mark" style={{ left: '22%' }}>1850</div>
            <div className="era-mark" style={{ left: '45%' }}>1900</div>
            <div className="era-mark" style={{ left: '67%' }}>1950</div>
            <div className="era-mark" style={{ left: '89%' }}>2000</div>
            <div className="era-mark" style={{ left: '100%' }}>2024</div>
          </div>
        </div>
      </div>
      ...
      {/* <div className="v3-control-panel">
        ...
        <div className="year-controls">
          <button 
            ...
            onClick={() => handleYearChange(Math.max(1800, year - 10))}
          >
            -X
          </button>
          <button 
            className="v3-btn secondary"
            onClick={() => handleYearChange(Math.max(1800, year - 1))}
          >
            -I
          </button>
          <button 
          ...
          <button 
            className="v3-btn secondary"
            onClick={() => handleYearChange(Math.min(2024, year + 10))}
          >
            +X
          </button>
        </div>
