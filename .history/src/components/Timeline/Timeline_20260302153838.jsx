...
const Victoria3Timeline = ({ onYearChange }) => {
  ...
  if (scrollRef.current) {
    ...
    const ratio = (newYear - MIN_YEAR) / (MAX_YEAR - MIN_YEAR);
    const targetScroll = ratio * (frame.scrollWidth - frame.clientWidth);
