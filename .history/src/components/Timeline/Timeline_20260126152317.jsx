        ...
        <div className="slider-frame">
          <div className="slider-track">
            ...
            <div
              ...
              style={{
                left: `${((year - MIN_YEAR) / (MAX_YEAR - MIN_YEAR)) * 90}%`,
              }}
            >
              {year}
            </div>
            ...
            <input
              ...
              style={{
                background: `linear-gradient(to right, 
                  #8B4513 #efdacb                #8B4513 ${((year - MIN_YEAR) / (MAX_YEAR - MIN_YEAR)) * 100}%, 
                  #F4E8D0 ${((year - MIN_YEAR) / (MAX_YEAR - MIN_YEAR)) * 100}%, 
                  #F4E8D0 100%)`,
              }}
            />
          </div>
          ...
          <div className="era-indicators">
            {[1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000].map(markYear => {
              const position = ((markYear - MIN_YEAR) / (MAX_YEAR - MIN_YEAR)) * 100;
              return (
