...
const Victoria3Timeline = ({ onYearChange }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    // ✨ FIX: Smoother calculation - use pixels directly
  ...
  // ✨ FIX: Calculate CSS transform to pan the ruler
  const getRulerTransform = () => {
    // How much to shift the ruler left to center the viewport
    const centerOffset = (viewportCenter - MIN_YEAR) / (MAX_YEAR - MIN_YEAR);
    const shift = -(centerOffset - 0.5) * 100; // Center at 50%
