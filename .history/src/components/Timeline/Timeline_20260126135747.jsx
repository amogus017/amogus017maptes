      ...
      <div className="v3-slider-container">
        <div className="slider-frame">
          <div className="slider-track">
            ...
            #8B4513 0%, 
            #8B4513 ${((year - 1300) / (2024 - 1300)) * 100}%, 
            #F4E8D0 ${((year - 1300) / (2024 - 1300)) * 100}%, 
            #F4E8D0 100%)`,
              }}
            />
          </div>
          ...
          <div className="era-indicators">
             {[1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2024].map(markYear => {
    const position = ((markYear - 1300) / (2024 - 1300)) * 100;
    return (
