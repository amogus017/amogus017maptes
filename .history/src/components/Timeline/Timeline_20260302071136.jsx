          ...
          <div className="slider-track">
            ...
            <div className="slider-wrapper">
              <div
                ...
                style={{
                  left: `${((year - viewportStart) / VIEWPORT_YEARS) * 100}%`, // ✨ CHANGED
                }}
              >
                {year}
              </div>
              ...
              <input
                type="range"
                className="v3-slider"
                min={viewportStart}  // ✨ CHANGED: Dynamic range
                max={viewportStart + VIEWPORT_YEARS}  // ✨ CHANGED
                value={year}
            ...
            style={{ cursor: isDragging ? 'grabbing' : 'grab' }}  // ✨ NEW
          >
            <div className="ruler-baseline" />
            {generateRulerMarks()}
          </div>
